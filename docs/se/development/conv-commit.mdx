...
Install [Conventional Commits](https://marketplace.visualstudio.com/items?itemName=vivaxy.vscode-conventional-commits) extension to help you to fill in commit message in Conventional Commits format.
...
Install [commitlint](./tools/commitlint.mdx) npm package to check commit messages against a set of rules to ensure they follow a consistent format, in this case is Conventional Commits format.


### action-semantic-pull-request (Github Action)

Use [action-semantic-pull-request](https://github.com/amannn/action-semantic-pull-request) in your GitHub Action workflow to ensure that your Github pull request titles match the Conventional Commits spec.
