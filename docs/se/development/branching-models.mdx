...
Feature flags (aka feature toggles) are conditional statements in the code that allows teams to enable or disable features without modifying code or redeploying.

They nicely complement TBD, allows developers to commit new feature code directly to the main branch within a feature flag path without creating a separate feature branch.
