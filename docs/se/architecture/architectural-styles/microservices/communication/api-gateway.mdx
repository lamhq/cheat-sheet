...
- **Risk of Becoming a "God Gateway"**. Putting too much business logic into the gateway turns it into a complex monolith, defeating the purpose of microservices. It should stick to gateway-specific tasks only.
