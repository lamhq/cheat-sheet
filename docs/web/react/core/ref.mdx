...
> [!TIP]
> In child component, you can expose a custom value instead of the DOM node using the [`useImperativeHandle`](https://react.dev/reference/react/useImperativeHandle) hook.
