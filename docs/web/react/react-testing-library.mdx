...
<PackageManagerTabs command="install --save-dev eslint-plugin-testing-library eslint-plugin-jest-dom" />

```js title="eslint.config.js" {2,3,9,10}
...
References:
- [eslint-plugin-testing-library](https://github.com/testing-library/eslint-plugin-testing-library?tab=readme-ov-file#shareable-configurations)
