...
export const Primary: Story = {
  args: { // [!code highlight]
    primary: true, // [!code highlight]
    label: 'Button', // [!code highlight]
  }, // [!code highlight]
};
```
...
// Replace your-framework with the framework you are using, e.g. react-vite, nextjs, nextjs-vite, etc.
import type { Meta, StoryObj } from '@storybook/your-framework';
import { useArgs } from 'storybook/preview-api'; // [!code highlight]
...
export const Example = {
  ...
  render: function Render(args) {
    const [{ isChecked }, updateArgs] = useArgs(); // [!code highlight]
// [!code highlight]
    function onChange() { // [!code highlight]
      updateArgs({ isChecked: !isChecked }); // [!code highlight]
    } // [!code highlight]
...
const meta = {
  ...
  args: { onClick: fn() }, // [!code highlight]
} satisfies Meta<typeof Button>;
  ...
  parameters: {
    backgrounds: { // [!code highlight]
      options: { // [!code highlight]
        light: { name: 'Light', value: '#fff' }, // [!code highlight]
        dark: { name: 'Dark', value: '#333' }, // [!code highlight]
      }, // [!code highlight]
    }, // [!code highlight]
  },
};
...
const preview: Preview = {
  decorators: [
    ...
    (Story, { args, argTypes, globals, hooks, parameters, viewMode }) => { // [!code highlight]
      return ( // [!code highlight]
        <div className="page-layout"> // [!code highlight]
...
const meta = {
  title: 'Design System/Atoms/Button', // [!code highlight]
  component: Button,
} satisfies Meta<typeof Button>;
