...
* [Product Vision and Goals](./context.mdx): Understand the high-level vision and objectives of the product to ensure alignment with business goals.
* [System Architecture and Design Principles](./context.mdx): Overall system architecture, design patterns, and design principles that guide the development process.
* [Contributing Guidelines](./context.mdx): Overview of the project's contributing guidelines and collaboration practices.
