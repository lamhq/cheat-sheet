...
Rather than scheduling a container, Kubernetes instead schedules a pod.

A **pod** consists of one or more containers that will be deployed together. You often have one container in a pod.
