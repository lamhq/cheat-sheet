...
See [Prompt Engineering](../ai-agents/prompt.mdx#prompt-engineering).
...
Extend the AI's capabilities with tools from [MCP](../ai-agents/mcp.mdx) servers or Marketplace extensions.
