...
1. Create a new Serena project & index it
   ```bash
   uvx --from git+https://github.com/oraios/serena serena project create --name "bid-up-api" --index
   ```
2. [Activate project](https://oraios.github.io/serena/02-usage/040_workflow.html#project-activation) to make Serena aware of the project you want to work with
3. Start Serena and let it create memory files (`.serena/memories/`). Agent can choose to read them in subsequent interactions. You can also add new ones or edit manually.
