...
This document is applied for version: `16.3.2` (2026)
...
<PackageManagerTabs command="install --save-dev @testing-library/react@^16.3.2 @testing-library/dom@^10.4.1" />


## Setting up Jest

<PackageManagerTabs command="install --save-dev jest-environment-jsdom@^30.3.0 @testing-library/jest-dom@^6.9.1 identity-obj-proxy@^3.0.0" />
...
<PackageManagerTabs command="install --save-dev @testing-library/jest-dom@^6.9.1" />
